...
> data Figure = Figure Shape Point deriving (Show)
...
> move (Figure (Circle r) (XY a b)) dx dy = (Figure (Circle r) (XY (a+dx) (b+dy)))
> move (Figure (Rectangle l w) (XY a b)) dx dy = (Figure (Rectangle l w) (XY (a+dx) (b+dy)))
